process COLLATE_PROCESSED_READS {
    label 'process_high'
    conda "python=3.8.3"
    container "${workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ? 'docker.io/nfcore/dualrnaseq:dev' : 'docker.io/nfcore/dualrnaseq:dev'}"
